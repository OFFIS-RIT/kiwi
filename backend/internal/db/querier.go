...
type Querier interface {
	...
	DeleteOldCompletedBatches(ctx context.Context) error
	...
	GetGroupsForUser(ctx context.Context, userID int32) ([]GetGroupsForUserRow, error)
	...
	GetProjectBatchProgress(ctx context.Context, correlationID string) (GetProjectBatchProgressRow, error)
	...
	GetProjectsForUser(ctx context.Context, userID int32) ([]GetProjectsForUserRow, error)
