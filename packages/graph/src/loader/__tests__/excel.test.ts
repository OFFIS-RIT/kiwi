...
describe("ExcelLoader", () => {
    test("flattens visible sheets into one markdown document", async () => {
        ...
        expect(fixture.text).toContain("## Sheet: Summary");
        expect(fixture.text).toContain("## Sheet: Details");
        expect(fixture.text).toMatch(/\| Name \| Value \|/);
        expect(fixture.text).toMatch(/\| Foo \| 42 \|/);
        expect(fixture.text).toMatch(/\| Id \| Score \|/);
        expect(fixture.text).toMatch(/\| 1 \| 91 \|/);
    });

    test("skips hidden sheets from flattened output", async () => {
        const fixture = await buildFixture();
