        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogFooter>
                    ...
                    <Button variant="destructive" onClick={handleDelete} disabled={deleteGroupMutation.isPending}>
                        {deleteGroupMutation.isPending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                        {t("delete")}
                    </Button>
                </DialogFooter>
            </DialogContent>
