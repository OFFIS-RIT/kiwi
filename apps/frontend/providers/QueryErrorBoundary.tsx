 ...
 */
class QueryErrorBoundaryInner extends Component<QueryErrorBoundaryProps, QueryErrorBoundaryState> {
                ...
                <div className="flex h-screen items-center justify-center bg-background">
                    <div className="max-w-md space-y-4 text-center p-6">
                        <div className="space-y-2">
                            <h1 className="text-2xl font-bold text-destructive">{translations.somethingWentWrong}</h1>
                            <p className="text-muted-foreground">{translations.unexpectedError}</p>
                        </div>
                        ...
                        <div className="flex gap-3 justify-center">
                            ...
                            <Button onClick={this.handleReload}>{translations.reloadPage}</Button>
                        </div>
...
export function QueryErrorBoundary({ children }: { children: ReactNode }) {
    ...
    return <QueryErrorBoundaryInner translations={translations}>{children}</QueryErrorBoundaryInner>;
}
