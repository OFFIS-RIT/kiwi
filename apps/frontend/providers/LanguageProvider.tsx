...
const translations = {
    en: {
        ...
        "process.remaining_approx_one": "1 minute remaining",
        "process.remaining_approx_many": "{minutes} minutes remaining",
    ...
    de: {
        ...
        "process.remaining_approx_one": "1 Minute verbleibend",
        "process.remaining_approx_many": "{minutes} Minuten verbleibend",
