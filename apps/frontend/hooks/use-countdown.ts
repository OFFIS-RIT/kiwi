 ...
 */
export function useCountdown(serverTimeRemaining: number | undefined, dataUpdatedAt?: number): number | undefined {
    const [countdown, setCountdown] = useState<number | undefined>(serverTimeRemaining);
