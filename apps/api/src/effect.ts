...
export const ApiLayer = Layer.mergeAll(AiModelRegistryLayer, FileStorageLive, AiClientFactoryLive);

export type ApiServices = Database | FileStorage | AiModelRegistry | AiClientFactory;
