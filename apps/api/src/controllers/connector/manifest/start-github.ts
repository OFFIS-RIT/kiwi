...
export function startGitHubConnectorManifest(input: {
    user: AuthUser;
    body: GitHubConnectorManifestStartInput;
}): Effect.Effect<{ state: string; manifestUrl: string }, ReturnType<typeof toApiError>> {
