...
export const assertCanManageUserPrompts = Effect.fn("assertCanManageUserPrompts")(function* (
    user: AuthUser,
    targetUserId: string
) {
...
export const assertCanManageOrganizationPrompts = Effect.fn("assertCanManageOrganizationPrompts")(function* (
    user: AuthUser,
    organizationId: string
) {
    ...
    if (!organization) {
        return yield* Effect.fail(organizationNotFoundError());
    }

    return organization;
});

export const assertCanManageTeamPrompts = Effect.fn("assertCanManageTeamPrompts")(function* (
    user: AuthUser,
    teamId: string
) {
...
export const assertCanManageGraphPrompts: (
    user: AuthUser,
    graphId: string
) => Effect.Effect<GraphRecord, unknown, Database> = Effect.fn("assertCanManageGraphPrompts")(function* (
    user: AuthUser,
    graphId: string
) {
