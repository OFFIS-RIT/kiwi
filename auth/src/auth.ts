...
const ldapEnabled = Boolean(
    env.LDAP_URL && env.LDAP_BIND_DN && env.LDAP_PASSW && env.LDAP_BASE_DN && env.LDAP_SEARCH_ATTR,
);
        ...
        ...(env.MICROSOFT_CLIENT_ID && env.MICROSOFT_CLIENT_SECRET
            ? {
                  microsoft: {
                      ...
                      authority: env.MICROSOFT_AUTHORITY_URL ? env.MICROSOFT_AUTHORITY_URL : undefined,
