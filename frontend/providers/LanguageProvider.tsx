...
const translations = {
  en: {
    ...
    "auth.description":
      "Use your KIWI account to access your groups and projects.",
    "auth.name": "Name",
    "auth.name.placeholder": "Jane Doe",
    "auth.email": "Email",
    "auth.email.placeholder": "you@example.com",
    "auth.password": "Password",
    "auth.sign.in": "Sign in",
    "auth.sign.up": "Create account",
    "auth.switch.to.sign.up": "Need an account? Create one",
    "auth.switch.to.sign.in": "Already have an account? Sign in",
  ...
  de: {
    ...
    "auth.session.loading": "Sitzung wird geprueft...",
    error: "Fehler",
    ...
    "auth.description":
      "Melde dich mit deinem KIWI-Konto an, um auf deine Gruppen und Projekte zuzugreifen.",
    "auth.name": "Name",
    "auth.name.placeholder": "Max Mustermann",
    "auth.email": "E-Mail",
    "auth.email.placeholder": "du@example.com",
    "auth.password": "Passwort",
    "auth.sign.in": "Anmelden",
    "auth.sign.up": "Konto erstellen",
    "auth.switch.to.sign.up": "Noch kein Konto? Jetzt erstellen",
    "auth.switch.to.sign.in": "Du hast bereits ein Konto? Jetzt anmelden",
    "auth.error.default":
