...
const translations = {
  en: {
    ...
    "auth.signin.description": "Sign in to continue",
    "auth.signup.description": "Enter your details to register",
    "auth.name": "Name",
    "auth.email": "Email",
    ...
    "auth.signing.up": "Registering...",
    "auth.password.min": "Minimum 8 characters",
    "auth.or": "Or",
    "auth.microsoft": "Sign in with Microsoft",
    "auth.no.account": "No account yet? Register",
    ...
    "auth.error.registration.failed": "Registration failed",
    "auth.error.generic": "An error occurred",
    "auth.microsoft.not.configured": "Microsoft login not configured yet",
    "auth.username.placeholder": "John Doe",
    "auth.email.placeholder": "mail@example.com",
  ...
  de: {
    ...
    "auth.signin.description": "Melde dich an, um fortzufahren",
    "auth.signup.description": "Gib deine Daten ein, um dich zu registrieren",
    "auth.name": "Name",
    "auth.email": "E-Mail",
    "auth.password": "Passwort",
    "auth.signin": "Anmelden",
    "auth.signup": "Registrieren",
    "auth.signing.in": "Anmelden...",
    "auth.signing.up": "Registrieren...",
    "auth.password.min": "Mindestens 8 Zeichen",
    "auth.or": "Oder",
    "auth.microsoft": "Mit Microsoft anmelden",
    "auth.no.account": "Noch kein Konto? Registrieren",
    "auth.has.account": "Bereits registriert? Anmelden",
    "auth.error.name.required": "Name ist erforderlich",
    "auth.error.email.required": "E-Mail ist erforderlich",
    "auth.error.email.invalid": "Ungültige E-Mail-Adresse",
    "auth.error.password.required": "Passwort ist erforderlich",
    "auth.error.password.min": "Passwort muss mindestens 8 Zeichen lang sein",
    "auth.error.login.failed": "Login fehlgeschlagen",
    "auth.error.registration.failed": "Registrierung fehlgeschlagen",
    "auth.error.generic": "Ein Fehler ist aufgetreten",
    "auth.microsoft.not.configured": "Microsoft Login noch nicht konfiguriert",
    "auth.username.placeholder": "Max Mustermann",
    "auth.email.placeholder": "mail@example.com",
    "auth.password.placeholder": "••••••••",
    "auth.show.password": "Passwort anzeigen",
    "auth.hide.password": "Passwort verbergen",
  },
};
