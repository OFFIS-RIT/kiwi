...
- Prefer Effect composition for async error handling. Prefer returning/combining `Effect` values over route-local `try/catch` wrappers when no cleanup, rollback, or fallback behavior is needed.
